...
<main>
    <div class="row align-items-center justify-content-center">
        ...
        <div class="col-sm-3 col-12 card-bg2 align-self-stretch">
            <p class="text-center card-text1 pt-5">
                Article
        ...
        <div class="col-sm-9 col-12 card-bg2 p-5">
            <form>
                ...
                <div class="form-group row justify-content-center pt-3">
                    <input type="button" value="Valider les changements" class="cursor-sm btn btn-primary rounded-0 strong-white" v-on:click="validateVersionUpdate" />
                </div>
